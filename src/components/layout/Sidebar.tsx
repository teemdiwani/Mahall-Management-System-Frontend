...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    roles: ['super_admin', 'madrasa_admin', 'imam'],
    children: [
      { key: 'madrasa-dash', label: 'Overview', icon: <BookOpen size={16} />, href: '/app/madrasa', roles: ['super_admin', 'madrasa_admin', 'imam'] },
      { key: 'madrasa-students', label: 'Students', icon: <Users size={16} />, href: '/app/madrasa/students', roles: ['super_admin', 'madrasa_admin'] },
      { key: 'madrasa-teachers', label: 'Teachers', icon: <UserCheck size={16} />, href: '/app/madrasa/teachers', roles: ['super_admin', 'madrasa_admin'] },
      { key: 'madrasa-classes', label: 'Classes', icon: <BookOpen size={16} />, href: '/app/madrasa/classes', roles: ['super_admin', 'madrasa_admin'] },
      { key: 'madrasa-attendance', label: 'Attendance', icon: <Calendar size={16} />, href: '/app/madrasa/attendance', roles: ['super_admin', 'madrasa_admin'] },
      { key: 'madrasa-exams', label: 'Exams & Results', icon: <FileText size={16} />, href: '/app/madrasa/exams', roles: ['super_admin', 'madrasa_admin'] },
    ],
  },
  {
    key: 'mosque',
